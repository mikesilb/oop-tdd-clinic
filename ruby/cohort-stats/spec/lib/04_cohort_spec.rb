...
describe Cohort do
  ...
  let(:cohort) do
    Cohort.new("Philtastic 4", Date.parse("2020/02/22"), Date.parse("2020/04/29"))
  end

  describe "#title" do
    it "has a reader for title" do
      expect(cohort.title).to eq("Philtastic 4")
    end
  ...
  describe "#career_kickoff" do
    ...
    it "should be different for the next cohort" do
      ...
      philly5 = Cohort.new("Philly 5", start_date, end_date)
